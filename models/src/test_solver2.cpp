...
int main (int argc, char ** argv) {
  ...
  data_param_label.set_batch_size(64);
  ...
  ConvolutionParameter* conv_param1 = conv1.add_convolution_param();
  ...
  PoolingParameter* pool_param1 = pool1.add_pooling_param();
  ...
  ConvolutionParameter* conv_param2 = conv2.add_convolution_param();
  ...
  PoolingParameter* pool_param2 = pool2.add_pooling_param();
...
//  ip1.setup_inner_product_param(ip_param1);
  InnerProductParameter* ip_param1 = ip1.add_inner_product_param();
  ...
  relu1.add_top("relu1");
  ReLUParameter* relu_param1 = relu1.add_relu_param();
...
//  ip2.setup_inner_product_param(ip_param2);
  InnerProductParameter* ip_param2 = ip2.add_inner_product_param();
  ...
  loss.add_top("loss");
  LossParameter* loss_param = loss.add_loss_param();
  ...
  AccuracyParameter* accuracy_param = accuracy.add_accuracy_param();
