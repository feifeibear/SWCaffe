...
mkdir -p ./log && bsub -b -I -q q_sw_share -host_stack 1024 -n $1 -cgsp 64 -sw3run ./sw3run-all -sw3runarg "-a 1" -cross_size 28000 ./bin/alexnet_sw 2>&1 | tee ./log/sw_alex_`date '+%y-%m-%d-%H-%M-%S'`.log
